...
public class Main extends Tournament{
...
//        int indexOfBattingTeam;
//        int indexOfBowlingTeam;
            ...
            if (totalRuns1 > totalRuns2) {
                ...
                teams.put(Ing1.Team1.TeamName, Ing1.Team1);
                teams.put(Ing1.Team2.TeamName, Ing1.Team2);
                ...
                teams.put(Ing2.Team1.TeamName, Ing2.Team1);
                teams.put(Ing2.Team2.TeamName, Ing2.Team2);
            ...
            //teams.set(teams.indexOf(Ing1.Team1.TeamName),Ing1.Team1);
            //teams.set(teams.indexOf(Ing1.Team2.TeamName),Ing1.Team2);

            System.out.println("Want to see Points Table    Type: Yes");
            String displayPointsTable = sc.next();
            if (displayPointsTable.equals("Yes")) {
                pointsTable();
            }
